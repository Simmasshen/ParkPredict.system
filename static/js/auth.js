...
function doLogin() {
  ...
  if (!user) {
    // For demo: accept any credentials as valid (remove in production)
    console.warn('Demo mode: accepting any credentials');
    sessionStorage.setItem('pp_user', JSON.stringify({ id, name: 'MMU Student' }));
